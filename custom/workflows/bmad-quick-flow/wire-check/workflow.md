...
- `installed_path` = `{project-root}/_bmad/bmm/workflows/bmad-quick-flow/wire-check`
...
Read fully and follow: `{project-root}/_bmad/bmm/workflows/bmad-quick-flow/wire-check/steps/step-01-map-wires.md` to begin the workflow.
