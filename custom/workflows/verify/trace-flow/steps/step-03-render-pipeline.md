...
Proceed immediately to `{project-root}/_bmad/bmm/workflows/verify/trace-flow/steps/step-04-audit.md` — even if all stages are green, the audit checks for subtler issues (unused fields, redundant fetches, type drift).
