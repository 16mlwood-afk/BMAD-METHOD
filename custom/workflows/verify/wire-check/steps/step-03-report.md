...
If issues were found (any loose, mismatched, or dead wires), proceed immediately to `{project-root}/_bmad/bmm/workflows/verify/wire-check/steps/step-04-fix-issues.md`.
