...
<!-- Also the home for: preserved-guard provenance (originating commit SHA + invariant) from the
     step-03 existing-code provenance pre-flight, and the step-04 brownfield Regression Surface table. -->
