...
Every value the user hasn't specified is **proposed and confirmed**, never imposed. Surface the proposed palette/type as a short block the user can approve or adjust before writing.
