...
description: 'Front door for production-driven work in brownfield projects. Take user reports, telemetry observations, error logs, dependency alerts — output small tech-specs ready for quick-dev. Use when the user says "what should I work on this week", "triage the backlog", or drops a list of production issues.'
...
3. **step-03-emit-tech-specs** — for the top N items, produce small tech-specs. Each becomes input for quick-spec (if it needs more design) or direct quick-dev (if it's already clear).
