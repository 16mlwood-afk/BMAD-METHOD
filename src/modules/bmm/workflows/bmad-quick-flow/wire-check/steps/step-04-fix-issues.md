...
When all issues are fixed and type-checked, proceed immediately to `{project-root}/_bmad/bmm/workflows/bmad-quick-flow/wire-check/steps/step-05-deliver.md`.
